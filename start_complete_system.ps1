# PowerShell script to start the complete Eventra system with frontend
Write-Host "🚀 Starting Complete Eventra System..." -ForegroundColor Green
Write-Host "This will start Python server, Node.js backend, and React frontend" -ForegroundColor Yellow
Write-Host ""
...
Write-Host "⚛️  Starting React Frontend on http://localhost:3000..." -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "🎯 Your Eventra system is now running!" -ForegroundColor Green
Write-Host ""
