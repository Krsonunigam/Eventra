...
const FaceCapture = ({ onCapture, onClose, isOpen, title = "Capture Your Face" }) => {
              ...
              <div className="space-y-4">
                ...
                <div className="text-center">
                  ...
                  <button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg flex items-center gap-2 mx-auto transition-colors disabled:opacity-50"
                  >
